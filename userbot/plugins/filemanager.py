...
async def _(event):
    ...
    OUTPUT = f"**Files in [ℝ𝔼𝔹𝔼𝕃𝔹𝕆𝕋](t.me/REBELBOT_official) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your REBELBOT server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of REBELBOT repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your REBELBOT server'
).add_command(
